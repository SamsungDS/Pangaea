...
<template>
  <v-container>
    ...
    <v-toolbar color="rgba(20, 40, 160, 0.1)">
        ...
        <v-window-item v-for="host in hosts" :value="host.id" :key="host.id">
          ...
          <v-row class="flex-0" dense>
            <v-col cols="12" sm="6" md="6" lg="4">
              <!-- Basic Information -->
              <v-card class="h-100" color="rgba(20, 40, 160, 0.1)">
                <v-toolbar height="45">
                ...
                <v-card-text>
                  <h2 class="text-h6 text-blue-lighten-2">CXL-Host</h2>
                ...
                <v-list lines="one">
                  ...
                  <v-list-item>
                    ...
                    <template v-slot:prepend>
                      <v-avatar>
                        <v-icon color="#1428A0">mdi-memory</v-icon>
                      </v-avatar>
                    </template>
                  </v-list-item>
                </v-list>
            ...
            <v-col cols="12" sm="12" md="6" lg="8">
              ...
              <v-card class="h-100">
                <v-toolbar height="45">
                  <v-toolbar-title style="cursor: pointer"
                  >【Ports connected to CXL Switch Upstream Port】</v-toolbar-title
                  >
                </v-toolbar>
                <v-card-text
          ...
          <v-row class="flex-0" dense>
            ...
            <v-col cols="12" sm="12" md="6" lg="8">
              ...
              <v-card class="h-100">
                <v-toolbar height="45">
                  <v-toolbar-title style="cursor: pointer"
                  >【CXL Memory Devices under VCS】</v-toolbar-title
                  >
                </v-toolbar>
                <v-card-text
                  style="max-height: 420px; overflow: hidden; padding: 0"
