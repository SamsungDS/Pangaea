...
<template>
  <v-container>
              ...
              <v-row class="flex-0" dense>
                <v-col cols="12" md="4" xl="2">
                  ...
                  >
                    ...
                    <v-card-text>
                      <h2 class="text-h6 text-blue-lighten-2">CXL Switch</h2>
                      A Switch either supports VCS or does not support it.
                      It also either supports Redfish service or does not support it.
                    </v-card-text>
                    <v-list lines="one">
                      <v-list-item>
                      ...
                      <v-list-item>
                        ...
                        <template v-slot:prepend>
                          <v-avatar>
                            <v-icon color="#1428A0">mdi-account-circle</v-icon>
                          </v-avatar>
                        </template>
                      </v-list-item>
                      <v-list-item>
                        <v-list-item-title>Switch Id</v-list-item-title>
                        <v-list-item-subtitle>
                          {{ selectedBladeId }}
                        </v-list-item-subtitle>
                        <template v-slot:prepend>
                          <v-avatar>
                            <v-icon color="#1428A0">mdi-shield-account</v-icon>
                          </v-avatar>
                        </template>
                      </v-list-item>
                      <v-list-item>
                        <v-list-item-title>Switch IP Address</v-list-item-title>
                        <v-list-item-subtitle>
                          {{ selectedBladeIp + ":" + selectedBladePort }}
                        </v-list-item-subtitle>
                        <template v-slot:prepend>
                          <v-avatar>
                            <v-icon color="#1428A0">mdi-ip</v-icon>
                          </v-avatar>
                        </template>
                      </v-list-item>
                    </v-list>
                ...
                <v-col cols="12" xl="10">
                  ...
                  <v-card class="card-shadow h-full" height="420">
                    <v-toolbar height="45">
                      <v-toolbar-title style="cursor: pointer"
                      >【Upstream Ports connected to CXL Host】</v-toolbar-title
                      >
                      <v-btn
                        icon="mdi-help-circle"
                        size="x-small"
              ...
              <v-row class="card-shadow flex-grow-0" dense>
                ...
                <v-col cols="12" xl="10">
                  ...
                  <v-card class="card-shadow h-full" height="420">
                    <v-toolbar height="45">
                      <v-toolbar-title style="cursor: pointer"
                      >【Downstream Ports connected to CXL Memory Device】</v-toolbar-title
                      >
                      <v-btn
                        icon="mdi-help-circle"
                        size="x-small"
              ...
              <v-row class="card-shadow flex-grow-0" dense>
                <v-col cols="12" xl="6">
                  ...
                  <v-card class="card-shadow h-full" height="420">
                    <v-toolbar height="45">
                      <v-toolbar-title style="cursor: pointer"
                      >CXL VCS Management</v-toolbar-title
                      >
                      <v-btn
                        icon="mdi-help-circle"
                        size="x-small"
                    ...
                    >
                      <v-row>
                        ...
                        <v-col>
                          ...
                          >👈 Click the left
                            <strong>Bind VPPB</strong> button to
    ...
    >
      <v-card>
        <v-card-title>
          <span class="text-h5">New Fabric</span>
        </v-card-title>
        <v-divider></v-divider>
        <v-card-text>
          <v-container>
    ...
    <v-dialog v-model="dialogAddApplianceSuccess" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Add a fabric succeeded!</h2>
    ...
    <v-dialog v-model="dialogAddApplianceFailure" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Add a fabric failed!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
          {{ addApplianceError }}
        </p>
        <v-divider class="mb-4"></v-divider>
    ...
    <v-dialog v-model="dialogDeleteAppliance" max-width="600px">
      <v-card>
        <v-alert
          ...
          title="Alert"
          variant="tonal"
          text="Delete fabric? The action cannot be undone."
        ></v-alert>
        <v-card-text>
    ...
    <v-dialog v-model="dialogDeleteApplianceSuccess" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Delete a fabric succeeded!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
    ...
    <v-dialog v-model="dialogDeleteApplianceFailure" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Delete a fabric failed!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
    ...
    <v-dialog v-model="dialogRenameAppliance" max-width="600px">
      <v-card>
        <v-card-title>
          <span class="text-h5">Rename Fabric</span>
        </v-card-title>
        <v-divider></v-divider>
        <v-card-text>
          <v-container>
    ...
    <v-dialog v-model="dialogRenameApplianceSuccess" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Rename a fabric succeeded!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
          New Appliance Id:
    ...
    <v-dialog v-model="dialogRenameApplianceFailure" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Rename a fabric failed!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
    ...
    <v-dialog v-model="dialogRenameBlade" max-width="600px">
      <v-card>
        <v-card-title>
          <span class="text-h5">Rename Switch</span>
        </v-card-title>
        <v-divider></v-divider>
        <v-card-text>
          <v-container>
    ...
    <v-dialog v-model="dialogRenameBladeSuccess" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Rename a Switch succeeded!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
          New Blade Id:
          <br />{{ renamedBladeId }}
        </p>
    ...
    <v-dialog v-model="dialogRenameBladeFailure" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Rename a Switch failed!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
          {{ renameBladeError }}
        </p>
        <v-divider class="mb-4"></v-divider>
    ...
    >
      <v-card>
        <v-card-title>
          <span class="text-h5">Add Switch</span>
        </v-card-title>
        <v-divider></v-divider>
        <v-card-text>
          <v-container>
    ...
    <v-dialog v-model="dialogAddBladeSuccess" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Add a switch succeeded!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
          New Blade Id:
          <br />{{ newBladeId }}
        </p>
    ...
    <v-dialog v-model="dialogAddBladeFailure" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Add a switch failed!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
          {{ addBladeError }}
        </p>
        <v-divider class="mb-4"></v-divider>
    ...
    <v-dialog v-model="dialogDeleteBlade" max-width="600px">
      <v-card>
        <v-alert
          ...
          title="Alert"
          variant="tonal"
          text="Delete switch? The action cannot be undone."
        ></v-alert>
        <v-card-text>
    ...
    <v-dialog v-model="dialogDeleteBladeSuccess" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Delete a switch succeeded!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
          Deleted Blade Id:
          <br />{{ deletedBladeId }}
        </p>
    ...
    <v-dialog v-model="dialogDeleteBladeFailure" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Delete a switch failed!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
          {{ deleteBladeError }}
        </p>
        <v-divider class="mb-4"></v-divider>
    ...
    <v-dialog v-model="dialogResyncBlade" max-width="600px">
      <v-card>
        <v-alert
          ...
          title="Alert"
          variant="tonal"
          text="Resynchronizing a switch deletes the switch and adds it back."
        ></v-alert>
        <v-card-text>
          <div class="text-h6 pa-12">{{ selectedBladeId }}</div>
        </v-card-text>
    ...
    <v-dialog v-model="dialogResyncBladeSuccess" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Resync the switch succeeded!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
    ...
    <v-dialog v-model="dialogResyncBladeFailure" max-width="600px">
      ...
      >
        <v-icon
          ...
          size="112"
        ></v-icon>
        <h2 class="text-h5 mb-6">Resync the switch failed!</h2>
        <p class="mb-4 text-medium-emphasis text-body-2">
          {{ resyncBladeError }}
        </p>
        <v-divider class="mb-4"></v-divider>
    ...
    <v-dialog v-model="dialogBasicInfoExplanation" max-width="600px">
      <v-card
        text="This is the basic information of the current switch."
      ></v-card>
    </v-dialog>
    <v-dialog v-model="dialogMemoryInfoExplanation" max-width="600px">
      <v-card
        text="This chart displays the available memory and allocated memory information for the current switch, and the information is updated with the bind or unbind memory action(s)."
      ></v-card>
    </v-dialog>
    <v-dialog v-model="dialogPortExplanation" max-width="600px">
      <v-card
        text="This table displays the ports information for the current switch, and the information is updated with the bind or unbind memory action(s)."
      ></v-card>
    </v-dialog>
    <v-dialog v-model="dialogMemoryRegionExplanation" max-width="600px">
      <v-card
        text="This table shows the memory chunks information of the current switch, the user is allowed to bind and unbind memory here, the corresponding memory management pie chart, ports information and resources information are constantly updated."
      ></v-card>
    </v-dialog>
    <v-dialog v-model="dialogResourceExplanation" max-width="600px">
      <v-card
        text="This table shows the resource blocks information of the current switch, the user can check the detail information of each resource block and the information is updated with the bind or unbind memory action(s)."
      ></v-card>
    </v-dialog>
  </v-container>
</template>
...
export default {
  data() {
    return {
      ...
      addApplianceProgressText: "Adding fabric, please wait...",
      deleteApplianceProgressText: "Deleting fabric, please wait...",
      addBladeProgressText: "Adding switch, please wait...",
      deleteBladeProgressText: "Deleting switch, please wait...",
      resyncBladeProgressText: "Resynchronizing the switch, please wait...",
      renameApplianceProgressText: "Renaming fabric, please wait...",
      renameBladeProgressText: "Renaming switch, please wait...",
  ...
  computed: {
    isAddBladeButtonDisabled() {
      return this.selectedApplianceId === "Discovered_Switches";
    },
  },
