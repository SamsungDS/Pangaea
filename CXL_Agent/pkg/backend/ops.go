...
type PortInformation struct {
	...
	PortType         string // The type of port, for example, "DSP" or "USP"
}
...
const (
	...
	ResourceComposed                         // The resource has been used for allocation and assignment through single usp.
	...
	ResourceShared                           // The resource has been used for allocation and assignment through multi usp, this is final state of resource
)
...
type GetResourceIdByVppbIdRequest struct {
	VppbId string
}
