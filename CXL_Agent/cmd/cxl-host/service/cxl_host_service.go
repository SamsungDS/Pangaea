...
func (s *CxlHostApiService) RedfishV1ChassisChassisIdPCIeDevicesPCIeDeviceIdCXLLogicalDevicesCXLLogicalDeviceIdGet(ctx context.Context, chassisId string, pCIeDeviceId string, cXLLogicalDeviceId string) (redfishapi.ImplResponse, error) {
	...
	// For PCIe device without dvsec (e.g. PPB or port without dvsec)
	if len(dev.PCIE) != 0 {
		...
		resource := redfishapi.CxlLogicalDeviceV111CxlLogicalDevice{
			...
			OdataId:      "/redfish/v1/Chassis/" + chassisId + "/PCIeDevices/" + pCIeDeviceId + "/CXLLogicalDevices/" + cXLLogicalDeviceId,
			OdataType:    CXLLogicalDevice,
			Description:  "CXL Logical Device " + "Type3",
			Id:           cXLLogicalDeviceId,
			Links: redfishapi.CxlLogicalDeviceV111Links{
				MemoryChunks: []redfishapi.OdataV4IdRef{
					{OdataId: "/redfish/v1/Chassis/" + chassisId + "/MemoryDomains/CXL/MemoryChunks/" + pCIeDeviceId},
			...
			MemorySizeMiB:      -1,
			Name:               "Locally attached CXL Logical Device " + "Type3",
			SemanticsSupported: []redfishapi.CxlLogicalDeviceV111CxlSemantic{},
			Status: redfishapi.ResourceStatus{
				Health: resourcehealthOk,
				State:  resourcestateEnabled,
			...
			Identifiers: []redfishapi.ResourceIdentifier{{
				DurableName:       nil,
				DurableNameFormat: redfishapi.ResourceV1191DurableNameFormat("GCXLID"),
			}},
		}
		return redfishapi.Response(http.StatusOK, resource), nil
	}
...
func (s *CxlHostApiService) RedfishV1ChassisChassisIdPCIeDevicesPCIeDeviceIdGet(ctx context.Context, chassisId string, pCIeDeviceId string) (redfishapi.ImplResponse, error) {
	...
	if len(dev.PCIE) != 0 {
		...
		// Find usp(pci-to-pci) serial number from predefined host-to-switch mapping (hostToSwitchDataStore.json)
		SN := HostToSwitchMap[chassisId].CxlSerialNumber
		...
		resource := redfishapi.PcieDeviceV1130PcieDevice{
			...
			Assembly:     redfishapi.OdataV4IdRef{},
			CXLDevice: redfishapi.PcieDeviceV1130CxlDevice{
				DeviceType:              redfishapi.PcieDeviceV1130CxlDeviceType(cxl.CxlDevType("CXLType3Device")), // pre-defined
				MaxNumberLogicalDevices: new(int64),
			},
			CXLLogicalDevices: redfishapi.OdataV4IdRef{
				OdataId: "/redfish/v1/Chassis/" + chassisId + "/PCIeDevices/" + pCIeDeviceId + "/CXLLogicalDevices",
...
// RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsGet -
func (s *CxlHostApiService) RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsGet(ctx context.Context, fabricId string, switchId string) (redfishapi.ImplResponse, error) {
	// TODO - update RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsGet with the required logic for this service method.
	// Add api_default_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, VirtualCxlSwitchCollectionVirtualCxlSwitchCollection{}) or use other options such as http.Ok ...
	// return Response(200, VirtualCxlSwitchCollectionVirtualCxlSwitchCollection{}), nil

	// TODO: Uncomment the next line to return response Response(0, RedfishError{}) or use other options such as http.Ok ...
	// return Response(0, RedfishError{}), nil

	return redfishapi.Response(http.StatusNotImplemented, nil), errors.New("RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsGet method not implemented")
}

// RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdGet -
func (s *CxlHostApiService) RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdGet(ctx context.Context, fabricId string, switchId string, vcsId string) (redfishapi.ImplResponse, error) {
	// TODO - update RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdGet with the required logic for this service method.
	// Add api_default_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, VirtualCxlSwitchV100VirtualCxlSwitch{}) or use other options such as http.Ok ...
	// return Response(200, VirtualCxlSwitchV100VirtualCxlSwitch{}), nil

	// TODO: Uncomment the next line to return response Response(0, RedfishError{}) or use other options such as http.Ok ...
	// return Response(0, RedfishError{}), nil

	return redfishapi.Response(http.StatusNotImplemented, nil), errors.New("RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdGet method not implemented")
}

// RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsGet -
func (s *CxlHostApiService) RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsGet(ctx context.Context, fabricId string, switchId string, vcsId string) (redfishapi.ImplResponse, error) {
	// TODO - update RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsGet with the required logic for this service method.
	// Add api_default_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, VirtualPci2PciBridgeCollectionVirtualPci2PciBridgeCollection{}) or use other options such as http.Ok ...
	// return Response(200, VirtualPci2PciBridgeCollectionVirtualPci2PciBridgeCollection{}), nil

	// TODO: Uncomment the next line to return response Response(0, RedfishError{}) or use other options such as http.Ok ...
	// return Response(0, RedfishError{}), nil

	return redfishapi.Response(http.StatusNotImplemented, nil), errors.New("RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsGet method not implemented")
}

// RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsVppbIdGet -
func (s *CxlHostApiService) RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsVppbIdGet(ctx context.Context, fabricId string, switchId string, vcsId string, vppbId string) (redfishapi.ImplResponse, error) {
	// TODO - update RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsVppbIdGet with the required logic for this service method.
	// Add api_default_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, VirtualPci2PciBridgeV100VirtualPci2PciBridge{}) or use other options such as http.Ok ...
	// return Response(200, VirtualPci2PciBridgeV100VirtualPci2PciBridge{}), nil

	// TODO: Uncomment the next line to return response Response(0, RedfishError{}) or use other options such as http.Ok ...
	// return Response(0, RedfishError{}), nil

	return redfishapi.Response(http.StatusNotImplemented, nil), errors.New("RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsVppbIdGet method not implemented")
}

// RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsVppbIdPatch -
func (s *CxlHostApiService) RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsVppbIdPatch(ctx context.Context, fabricId string, switchId string, vcsId string, vppbId string, virtualPci2PciBridgeV100VirtualPci2PciBridge redfishapi.VirtualPci2PciBridgeV100VirtualPci2PciBridge) (redfishapi.ImplResponse, error) {
	// TODO - update RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsVppbIdPatch with the required logic for this service method.
	// Add api_default_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(202, VirtualPci2PciBridgeV100VirtualPci2PciBridge{}) or use other options such as http.Ok ...
	// return Response(202, VirtualPci2PciBridgeV100VirtualPci2PciBridge{}), nil

	// TODO: Uncomment the next line to return response Response(0, RedfishError{}) or use other options such as http.Ok ...
	// return Response(0, RedfishError{}), nil

	return redfishapi.Response(http.StatusNotImplemented, nil), errors.New("RedfishV1FabricsFabricIdSwitchesSwitchIdVCSsVcsIdVPPBsVppbIdPatch method not implemented")
}
