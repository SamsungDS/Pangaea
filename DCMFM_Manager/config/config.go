...
type (
	...
	// CXL-Agent
	CXLAgent struct {
		CXLAgentIP   string `env-required:"true" yaml:"agent_ip" env:"AGENT_IP"`
		CXLAgentPort string `env-required:"true" yaml:"agent_port" env:"AGENT_HTTP_PORT"`
	}
)
